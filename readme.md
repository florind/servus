...
Web service that aggregates content from different sources in an asynchronous manner. The full description of the service is in my blog post: http://blog.newsplore.com/2010/06/27/building-a-content-aggregation-service-with-node-js
